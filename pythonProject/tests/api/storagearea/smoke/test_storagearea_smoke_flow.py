"""
Smoke-тесты для API StorageArea: последовательный сценарий
...
from tests.api.storagearea.steps import (
    _find_by,
    _get_list,
    _patch_delete,
    _patch_delete_many,
    ...
    _put,
    _put_many,
    build_unique_storagearea_payload,
...
def smoke_urls(base_server_url):
    ...
    return {
        "put_url": f"{base}/StorageArea/CreateOrUpdate",
        "put_many_url": base,
        "get_url": f"{base}/StorageArea",
        "post_url": f"{base}/StorageArea",
    }
...
@pytest.mark.test_name_ru("Smoke: PUT /StorageArea/CreateOrUpdate — создание одного объекта")
@testit.externalId("smoke_storagearea_01_create_one")
@testit.displayName("Smoke: PUT /StorageArea/CreateOrUpdate — создание одного объекта")
@testit.title("Smoke: PUT /StorageArea/CreateOrUpdate — создание одного объекта")
@testit.description(get_smoke_tc_description("storagearea", 1))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
def test_01_create_one(smoke_state, smoke_urls, smoke_base_warehouse_ref, admin_auth):
    payload = build_unique_storagearea_payload(smoke_base_warehouse_ref)
...
@pytest.mark.test_name_ru("Smoke: PUT /StorageArea/CreateOrUpdate — обновление одного объекта")
@testit.externalId("smoke_storagearea_01b_update_one")
@testit.displayName("Smoke: PUT /StorageArea/CreateOrUpdate — обновление одного объекта")
@testit.title("Smoke: PUT /StorageArea/CreateOrUpdate — обновление одного объекта")
@testit.description(get_smoke_tc_description("storagearea", 2))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
...
@pytest.mark.test_name_ru("Smoke: PUT /StorageArea/CreateOrUpdateMany — создание двух объектов")
@testit.externalId("smoke_storagearea_02_create_many")
@testit.displayName("Smoke: PUT /StorageArea/CreateOrUpdateMany — создание двух объектов")
@testit.title("Smoke: PUT /StorageArea/CreateOrUpdateMany — создание двух объектов")
@testit.description(get_smoke_tc_description("storagearea", 3))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
def test_02_create_many(smoke_state, smoke_urls, smoke_base_warehouse_ref, admin_auth):
    payloads = [build_unique_storagearea_payload(smoke_base_warehouse_ref) for _ in range(2)]
...
@pytest.mark.test_name_ru("Smoke: PUT /StorageArea/CreateOrUpdateMany — обновление двух объектов")
@testit.externalId("smoke_storagearea_02b_update_many")
@testit.displayName("Smoke: PUT /StorageArea/CreateOrUpdateMany — обновление двух объектов")
@testit.title("Smoke: PUT /StorageArea/CreateOrUpdateMany — обновление двух объектов")
@testit.description(get_smoke_tc_description("storagearea", 4))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
...
@pytest.mark.test_name_ru("Smoke: GET /StorageArea — в списке есть A, B1, B2")
@testit.externalId("smoke_storagearea_03_get_list")
@testit.displayName("Smoke: GET /StorageArea — в списке есть A, B1, B2")
@testit.title("Smoke: GET /StorageArea — в списке есть A, B1, B2")
@testit.description(get_smoke_tc_description("storagearea", 5))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
...
@pytest.mark.test_name_ru("Smoke: PATCH /StorageArea/Delete — удаление объекта A")
@testit.externalId("smoke_storagearea_04_delete_one")
@testit.displayName("Smoke: PATCH /StorageArea/Delete — удаление объекта A")
@testit.title("Smoke: PATCH /StorageArea/Delete — удаление объекта A")
@testit.description(get_smoke_tc_description("storagearea", 6))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
...
@pytest.mark.test_name_ru("Smoke: POST /StorageArea — фильтр по B1 и B2")
@testit.externalId("smoke_storagearea_05_post_filter")
@testit.displayName("Smoke: POST /StorageArea — фильтр по B1 и B2")
@testit.title("Smoke: POST /StorageArea — фильтр по B1 и B2")
@testit.description(get_smoke_tc_description("storagearea", 7))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
...
@pytest.mark.test_name_ru("Smoke: PATCH /StorageArea/DeleteMany — удаление B1 и B2")
@testit.externalId("smoke_storagearea_06_delete_many")
@testit.displayName("Smoke: PATCH /StorageArea/DeleteMany — удаление B1 и B2")
@testit.title("Smoke: PATCH /StorageArea/DeleteMany — удаление B1 и B2")
@testit.description(get_smoke_tc_description("storagearea", 8))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
...
@pytest.mark.test_name_ru("Smoke: POST /StorageArea — финальная проверка чистоты")
@testit.externalId("smoke_storagearea_07_post_clean")
@testit.displayName("Smoke: POST /StorageArea — финальная проверка чистоты")
@testit.title("Smoke: POST /StorageArea — финальная проверка чистоты")
@testit.description(get_smoke_tc_description("storagearea", 9))
@testit.nameSpace("API/Smoke")
@testit.className("StorageArea")
@testit.labels("api", "smoke", "storagearea")
